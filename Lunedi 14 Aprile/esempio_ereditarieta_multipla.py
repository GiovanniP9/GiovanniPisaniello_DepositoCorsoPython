...
class AutomobileSportiva(Veicolo, DotazioniSpeciali):
    ...
    def mostra_informazioni(self):
        super().mostra_informazioni() # Chiamiamo il metodo della prima superclasse perche ho sovrascritto il nome ma voglio comunque le informazioni della superclasse
